    ...
    <style>
        * {
        ...
        .cta-main:hover {
            ...
            box-shadow: 0 0 72px rgba(37, 211, 102, .38);
        }
        ...
        .pc.star {
            ...
            background: linear-gradient(145deg, #111, #0b1a0f);
            position: relative;
        }
        ...
        .final {
            ...
            background: linear-gradient(180deg, rgba(37, 211, 102, .05) 0%, transparent 60%);
        }
...
<body>
    ...
    <section class="hero">
        <div class="hero-badge">
            <div class="badge-dot"></div> Now available for Malaysian businesses
        </div>
        ...
        <p class="hero-desc">
            QLine lets customers join your queue through WhatsApp — from anywhere. They get notified when it's their
            turn. No crowding. No shouting numbers. No extra app to download.
        </p>

        <div class="cta-row">
            <a href="{{ $waNumber }}" class="cta-main">
        ...
        <div class="proof">
            <div class="proof-item">
                ...
                <div class="proof-label">Apps to download</div>
            </div>
            <div class="proof-div"></div>
            <div class="proof-item">
                <div class="proof-num">&lt;5min</div>
                <div class="proof-label">Setup time</div>
            </div>
            <div class="proof-div"></div>
            <div class="proof-item">
                <div class="proof-num">RM 15</div>
                <div class="proof-label">Start from / day</div>
            </div>
            <div class="proof-div"></div>
            <div class="proof-item">
                <div class="proof-num">100%</div>
                <div class="proof-label">WhatsApp-based</div>
            </div>
        </div>
    </section>
    ...
    <section class="problem">
        <div class="inner">
            <div class="r">
                ...
                <p class="sub">Long lines stress your staff, frustrate customers, and make your business look
                    disorganised — even when it isn't.</p>
            </div>
            <div class="pain-grid r">
                <div class="pain">
                    <div class="pain-emoji">😤</div>
                    <h3>Customers crowd the entrance</h3>
                    <p>People bunch up near your counter, blocking the space and making everyone uncomfortable —
                        especially during peak hours.</p>
                </div>
                <div class="pain">
                    <div class="pain-emoji">📢</div>
                    <h3>Staff shout numbers all day</h3>
                    <p>Calling names and numbers manually is exhausting, inconsistent, and easy to miss. Customers leave
                        thinking they were skipped.</p>
                </div>
                <div class="pain">
                    <div class="pain-emoji">😩</div>
                    <h3>Customers give up and leave</h3>
                    <p>No one wants to stand for 30 minutes just to wait. If they can't see the line moving, they walk
                        out — and don't come back.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="inner">
            ...
            <div class="steps-row">
                <div class="step r">
                    ...
                    <p>You get a unique QR code for your business. Print it, tape it near your entrance. That's it on
                        your end.</p>
                </div>
                <div class="step r">
                    ...
                    <p>They point their camera at the QR. WhatsApp opens automatically — no typing, no form, no
                        registration.</p>
                </div>
                <div class="step r">
                    ...
                    <p>QLine sends them their queue number, their position, how long to wait, and a link to track it
                        live.</p>
                </div>
                <div class="step r">
                    ...
                    <p>They can wait in their car, grab a coffee, or sit anywhere. QLine messages them when their turn
                        is close.</p>
                </div>
            </div>
        </div>
    ...
    <section class="demo">
        <div class="inner">
            <div class="phone-wrap r">
                <div class="phone">
                    ...
                    <div class="pb">
                        ...
                        <div class="bbl bi">Feel free to wait in your car or nearby — we'll message you when you're
                            almost up! 🚗</div>
            ...
            <div class="demo-left r">
                ...
                <p>QLine sends automatic WhatsApp messages at every step — so your customers are never left wondering
                    "am I next?" and your staff never have to manually notify anyone.</p>
        ...
        <div class="inner">
            ...
            <div class="ben-grid">
                <div class="ben-big r">
                    ...
                    <p>When customers can wait anywhere, your space stays clear. Clinics, banks, and government offices
                        using QLine report dramatically less crowding — even during peak hours. Your staff can finally
                        focus on serving, not managing the crowd.</p>
                </div>
                <div class="ben-sm r">
                    <div class="ben-icon">💬</div>
                    <h3>No new app. Just WhatsApp.</h3>
                    <p>Every Malaysian already has WhatsApp. Customers don't need to learn anything new — they just scan
                        and tap.</p>
                </div>
                <div class="ben-sm r">
                    <div class="ben-icon">⚡</div>
                    <h3>Up and running in 5 minutes</h3>
                    <p>Register your business, print your QR, display it. Your first customer can join the queue today —
                        no IT setup needed.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="pricing" id="pricing">
        <div class="inner">
            <div class="r">
                ...
                <p class="price-note-top">No complicated plans. No hidden fees. Every business gets the exact same
                    features — just pick daily or monthly.</p>
            </div>
            <div class="pc-grid r">
                <div class="pc">
                    <div class="pc-label">Daily Pass</div>
                    <p class="pc-who">Perfect for events, pasar malam, pop-ups — anywhere you need a queue for just one
                        day.</p>
                    <div class="pc-price"><sup>RM</sup>15</div>
                    <div class="pc-per">per day</div>
                    <div class="pc-limit">Up to 500 customers per day</div>
                    <a href="{{ $waNumber }}" class="pc-btn">Get started →</a>
                </div>
                <div class="pc star">
                    <div class="star-label">Best Value</div>
                    <div class="pc-label">Monthly</div>
                    <p class="pc-who">For clinics, banks, regular businesses — that's less than RM 13 per day for a
                        whole month.</p>
                    <div class="pc-price"><sup>RM</sup>400</div>
                    <div class="pc-per">per month</div>
                    <div class="pc-limit">Up to 500 customers per day</div>
                    <a href="{{ $waNumber }}" class="pc-btn">Start free trial →</a>
                </div>
            </div>
            <p class="pricing-sub r">Payments via FPX or credit card. Cancel anytime. Queue is automatically paused if
                your plan expires.</p>
        </div>
    </section>
    ...
    <section class="testimonials">
        <div class="inner">
            ...
            <div class="t-grid">
                <div class="tc r">
                    <div class="stars">★★★★★</div>
                    <p class="tc-q">"Before QLine, patients would crowd our reception from 8am. Now they scan the QR,
                        go sit in their car, and we WhatsApp them when it's their turn. My nurses are so much less
                        stressed."</p>
                    <div class="tc-a">
                        <div class="tc-av">DR</div>
                        <div>
                            <div class="tc-name">Dr. Razif</div>
                            <div class="tc-biz">Klinik Mesra, Kuantan</div>
                        </div>
                    </div>
                </div>
                <div class="tc r">
                    <div class="stars">★★★★★</div>
                    <p class="tc-q">"I printed the QR, stuck it on the counter, and customers were already using it
                        by lunchtime. No setup headache at all. My customers actually thank me for it now."</p>
                    <div class="tc-a">
                        <div class="tc-av">SL</div>
                        <div>
                            <div class="tc-name">Siti Lailah</div>
                            <div class="tc-biz">Kedai Jahit Siti, KL</div>
                        </div>
                    </div>
                </div>
                <div class="tc r">
                    <div class="stars">★★★★★</div>
                    <p class="tc-q">"We handle over 200 customers a day across 3 counters. QLine manages all of them
                        without any complaints. People actually say they prefer waiting this way."</p>
                    <div class="tc-a">
                        <div class="tc-av">AB</div>
                        <div>
                            <div class="tc-name">Ahmad Basri</div>
                            <div class="tc-biz">Pejabat Kaunter, Negeri Sembilan</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="final">
        <div class="r">
            ...
            <p class="final-micro">No app needed &nbsp;·&nbsp; Works on any phone &nbsp;·&nbsp; Cancel anytime
                &nbsp;·&nbsp; Malaysian support</p>
        </div>
    </section>
