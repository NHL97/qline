...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { background: #f0fdf4; font-family: Arial, sans-serif; min-height: 100vh; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 20px; }
        .card { background: #fff; border-radius: 20px; padding: 40px; max-width: 400px; width: 100%; text-align: center; box-shadow: 0 4px 24px rgba(0,0,0,0.08); }
        .business { font-size: 0.9rem; color: #6b7280; margin-bottom: 8px; }
        .ticket { font-size: 5rem; font-weight: 900; color: #16a34a; line-height: 1; margin: 16px 0; }
        .status-badge { display: inline-block; padding: 6px 16px; border-radius: 999px; font-size: 0.8rem; font-weight: 700; margin-bottom: 24px; }
        ...
        .info-label { font-size: 0.85rem; color: #9ca3af; }
        .info-value { font-size: 0.85rem; font-weight: 600; color: #111827; }
        .message { margin-top: 24px; padding: 16px; border-radius: 12px; font-size: 0.9rem; }
        .message-serving { background: #dcfce7; color: #166534; }
        .message-done { background: #f0fdf4; color: #166534; }
        .message-cancelled { background: #fee2e2; color: #991b1b; }
        .cancel-btn { margin-top: 24px; width: 100%; padding: 12px; border-radius: 12px; background: #fee2e2; color: #991b1b; font-weight: 600; font-size: 0.9rem; border: none; cursor: pointer; }
        .cancel-btn:hover { background: #fecaca; }
        .powered { margin-top: 24px; font-size: 0.75rem; color: #d1d5db; }
        .flash { background: #dcfce7; color: #166534; padding: 12px 16px; border-radius: 10px; margin-bottom: 16px; font-size: 0.9rem; }
    </style>
</head>
<body>
